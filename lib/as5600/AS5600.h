/// \file AS5600.h
/// \authors Rob Tillaart -- original version
/// \authors Daniel Williams -- port to PICO-C-SDK compatible library
/// \version: 0.6.1
/// \details Interface library for AS5600 magnetic rotation meter
//
#pragma once
...
#define AS5600_LIB_VERSION              "0.6.1"
...
public:
    ...
    // memory-location of direction flag
    static constexpr uint8_t AS5600_SW_DIRECTION_PIN   = 255;

public:
    enum {
        POWER_MODE_NOMINAL  = 0,
        POWER_MODE_LOW1     = 1,
        POWER_MODE_LOW2     = 2,
        POWER_MODE_LOW3     = 3
    } AS5600_POWER_MODE;
...
private:
    static constexpr uint8_t i2c_addr = AS5600_ADDRESS;
    i2c_inst_t * bus;
